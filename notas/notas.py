...
class EditorNotas(tk.Tk): #tk.Tk es la ventana principal. 
    def __init__(self):
        super().__init__()
        ...
        #crea area de texto
        self.text_area = tk.Text(self)#tk.Text es un widget de texto multilínea.
        self.text_area.pack(expand=True, fill=tk.BOTH)# Lo empaquetamos para que ocupe todo (expand True fill both).
    ...
    def crear_menu(self):
        ...
        filemenu = tk.Menu(menubar, tearoff=0)#filemenu submenu
